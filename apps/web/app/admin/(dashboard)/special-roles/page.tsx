            ...
            <div className="flex items-center justify-center min-h-[60vh]">
              <div className="flex flex-col items-center justify-center px-6">
                ...
                <h3 className="mt-6 text-xl font-semibold">
                  {searchQuery ? 'Tidak ada special role yang sesuai' : 'Belum ada special role'}
                </h3>
                <p className="mt-2 text-sm text-muted-foreground text-center max-w-sm">
                  {searchQuery
                    ? 'Coba ubah kata kunci pencarian untuk menemukan special role yang Anda cari.'
                    : 'Special role memberikan akses khusus ke menu admin tertentu. Buat special role pertama untuk memberikan akses terbatas kepada user.'}
                </p>
                {!searchQuery && (
                  <Button onClick={() => setIsCreateOpen(true)} className="mt-6">
                    <Plus className="mr-2 h-4 w-4" />
                    Buat Special Role Pertama
                  </Button>
                )}
              </div>
            </div>
